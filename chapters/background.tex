...

{
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            UAFX \cite{bib:uafx} & Yes & Yes & Yes \\\hline
...
Another, more significant obstacle is the difficulty explicitly described in tracking reference counts (page 9 of the paper \cite{bib:uafx}, \textit{Reference Count Mechanisms}).
